...
parser.add_argument('--train_phrase', help='Three phrase 1,2,3', default=10, type=float)
...
if category == 'nitre':
    num_epochs = 8000
    train_data_dir1 = './data/train/ntire/'
    train_data_gt1 = './data/train/ntire_gt/'
...
train_data_loader = DataLoader(train_data, batch_size=train_batch_size, shuffle=True,num_workers=2,pin_memory=True)
print('Data Finished!')
